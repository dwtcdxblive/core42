...
const activitiesEn = [
  ...
  { strong: "No-Objection", normal: " - Certificates (NOCs)" },
];

const activitiesAr = [
  { strong: "تراخيص", normal: " - أعمال البناء" },
  { strong: "التوسعة", normal: " - والتعلية للمباني" },
  { strong: "شهادات", normal: " - عدم الممانعة" },
];
...
const headSection_ar = {
  ...
  return (
    <main className="min-vh-100 d-flex bg-transparent align-items-start  ">
      <div className="container py-5">
        ...
        <div className="row align-items-start bg-white  rounded-1  justify-content-center gy-4 mt-5">
          ...
          {/* Center QR */}
            <div className="col-8 col-sm-6 col-md-2 text-center position-relative d-flex flex-column justify-content-end align-items-center" >
            <img
              src={qrBuildDubai}
              alt="QR Code"
         ...
         <footer className="dn__logos w-100">
                  ...
                  <img src={buildDubaiSponsers} className="mw-100" alt="Dubai Now partners" />
                </footer>
      </div>
    </main>
  );
