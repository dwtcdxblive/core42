...
const pageTitle = "Core42 Sovereign Public Cloud"
const videoTitleId = "sovereignCloudVideoTitle"
const videoHeading = "Core42 Sovereign Public Cloud Overview"
...
const C42SovereignCloud = () => {
  ...
  return (
    <main className="c42-sovereign min-vh-100 py-5 d-flex flex-column align-items-center">
...
export default C42SovereignCloud
