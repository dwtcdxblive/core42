...
const pageTitle = "Core42 Compass"
const videoTitleId = "compassVideoTitle"
const videoHeading = "Core42 Compass Overview"
...
const resourceTiles = [
  ...
  { title: "Sales Deck", href: "https://drive.google.com/file/d/1d73mpQtzMy9vasGA1u3J213WH9hCKvD4/view?usp=drive_link" },
...
const C42Compass = () => {
  ...
  return (
    <main className="c42-compass min-vh-100 py-5 d-flex flex-column align-items-center">
