...
const pageTitle = "Core42 AI Cloud"
const videoTitleId = "aiCloudVideoTitle"
const videoHeading = "Core42 AI Cloud Overview"
...
const C42AiCloud = () => {
  ...
  return (
    <main className="c42-aicloud min-vh-100 py-5 d-flex flex-column align-items-center">
